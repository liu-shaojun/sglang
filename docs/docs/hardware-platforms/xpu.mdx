...
compact. IQ4_NL and IQ4_XS are prepared as signed codebook values, and Q5_K as
affine INT8 codes, all with 32-value group scales; Q3_K and Q6_K use signed
...
- Q4_K linear and MoE gate/up weights use the direct compact-metadata kernel;
  IQ4_NL, IQ4_XS, Q3_K, Q6_K, and Q8_0 linear and MoE down weights use
