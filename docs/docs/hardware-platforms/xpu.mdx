...
compact. Q5_K is prepared as affine INT8 codes with 32-value group scales and
minimums, while Q6_K uses signed INT8 with 16-value group scales. Both use less
...
- Q4_K linear and MoE gate/up weights use the direct compact-metadata kernel;
  Q6_K and Q8_0 linear and MoE down weights use signed-INT8 kernels. Other
  K-quant projections are dequantized once during loading.
